...
draw_text(5,30,"player_camera viewport:"+string(camera_get_view_width(player_camera))+"x"+string(camera_get_view_height(player_camera)))
...
draw_text(5,70,"player_camera Speed:"+string(obj_camera.camera_speed))
