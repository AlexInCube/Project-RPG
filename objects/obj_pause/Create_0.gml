...
ds_menu_main = scr_create_menu_page(
	...
	[scr_find_keyword("save_game"),			menu_element_type.button, 0, save_game],
	[scr_find_keyword("load_game"),			menu_element_type.button, 0, start_load],
	...
	[scr_find_keyword("exit_to_desktop"),	menu_element_type.button, 0, game_exit]
)
