...
function input_cursor_prev_x(_player_index = 0)
{
    ...
    {
        if (is_numeric(player_camera) && (player_camera >= 0) && (INPUT_MOUSE_MODE == 0))
        {
            return camera_get_view_x(player_camera) + prev_x;
        }
        else
        {
            return prev_x;
