...
///@arg questid
function quest_get_current_task(argument0) {
...
*/
function quest_get_task_amount(argument0) {
	var questid = argument0
	var stagearray = obj_questmanager.ds_quests[# 4,questid]//Link to array with tasks
...
///@arg questid
function quest_get_short_description_for_task(argument0,argument1) {
	var questid = argument0
...
///@arg questid
function quest_get_tasks_array(argument0) {
	var questid = argument0
	var sdescarray = obj_questmanager.ds_quests[# 2,questid]//Link to array with tasks
	return sdescarray
}
...
///@arg questid
function quest_get_long_description_for_task(argument0) {
	var questid = argument0
	var stagenumber = global.ds_current_quests[? string(questid)]//Quest Progress
...
///@arg questid
function quest_get_current_stage(argument0) {
	var questid = argument0
...
///@arg questid
function quest_get_name(argument0) {
	var questid = argument0
...
///@arg questid
function quest_get_description(argument0) {
	var questid = argument0
