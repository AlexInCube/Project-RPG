...
for(i = 0;  i < ds_grid_width(craft_map); i++)
	{
		if global.crafting_inventory[# 0,0] == craft_map[# i, 1] and global.crafting_inventory[# 1,0] == craft_map[# i, 2]
		{
			if scr_mouseover(xx,yy,xx+32,yy+32) and mouse_check_button_pressed(mb_left)
			{
				global.crafting_inventory[# 0,1]-=1
				global.crafting_inventory[# 1,1]-=1
