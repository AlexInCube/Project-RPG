...
/// @function scr_draw_filtered_slot
/// @param inventory_ID
/// @param slot_ID
/// @param x
/// @param y
...
var itemneed = argument5
	...
	{
		draw_sprite(spr_slot,imageindex,xx,yy)//draw slot background
	}
...
if scr_mouseover(xx,yy,xx+32,yy+32){
	...
	if global.item_index[# global.mouse_slot[# 0, 0],item_stat.type]==itemneed or global.mouse_slot[# 0, 0]=item.none
