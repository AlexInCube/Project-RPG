...
for (i=0;i<5;i++)
		...
		if mouse_check_button_pressed(mb_left){
			if scr_mouseover(guiwidth/2-70,guiheight/2-185+(0*50),guiwidth/2-38,guiheight/2-153+(0*50))//HP
			{
			...
			if scr_mouseover(guiwidth/2-70,guiheight/2-185+(1*50),guiwidth/2-38,guiheight/2-153+(1*50))//Mana
			{
			...
			if scr_mouseover(guiwidth/2-70,guiheight/2-185+(2*50),guiwidth/2-38,guiheight/2-153+(2*50))//Strength
			{
		...
		obj_player_stats.	strengthbufflevel+=1
			...
			if scr_mouseover(guiwidth/2-70,guiheight/2-185+(3*50),guiwidth/2-38,guiheight/2-153+(3*50))//Intelligence
			{
		...
		obj_player_stats.	intelligencebufflevel+=1
			...
			if scr_mouseover(guiwidth/2-70,guiheight/2-185+(4*50),guiwidth/2-38,guiheight/2-153+(4*50))//Luck
			{
