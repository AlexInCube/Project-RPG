function scr_registeritems() {
	...
	//Weapon
	scr_add_weapon(item.wooden_stick,"wooden_stick",spr_item_weapon_wooden_stick,2,0,scr_wooden_stick_tick,nothing,scr_wooden_stick_create,nothing)
	/*
	...
	*/
	scr_add_weapon(item.shotgun,"shotgun", spr_item_weapon_shotgun,2,0,scr_shotgun_tick,scr_shotgun_draw,scr_shotgun_create,scr_shotgun_alarm)
	//Spell
