...
//Weapon
scr_add_weapon(item.iron_sword,"iron_sword", spr_ItemIcon_ironsword,10,0)
scr_add_weapon(item.lightningstaff,"light_staff", spr_MagicWeaponLightningStaff,0,10)
//Spell
scr_add_spell(item.scroll_dash,"spell_scroll_dash",spr_ItemIcon_SpellDash,1,1,scr_spell_dash)
//Other
