function registeritems() {
	//Potions
	add_potion(item.small_health_potion,"small_health_potion", spr_ItemIcon_SmallHealPotion,4,small_health_potion)
	add_potion(item.small_mana_potion,"small_mana_potion", spr_ItemIcon_SmallManaPotion,4,small_mana_potion)
	//Armor
