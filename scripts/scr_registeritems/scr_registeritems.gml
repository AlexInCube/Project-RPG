...
//Weapon
scr_add_weapon(item.iron_sword,"iron_sword", spr_ItemIcon_ironsword,10,0,item_type.meleeweapon)
scr_add_weapon(item.lightningstaff,"light_staff", spr_MagicWeaponLightningStaff,0,10,item_type.rangedweapon)
//Spell
